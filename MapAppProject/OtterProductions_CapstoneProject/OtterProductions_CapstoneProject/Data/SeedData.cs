...
{
    //Used your code from the example to create seed data

    /// <summary>
    /// Helper class to hold all the information we need to construct the users for this app.  Basically
    /// a union of MapAppUser and IdentityUser.  Not great to have to duplicate this data but it is only for one-time seeding
    ...
    {
        /// <summary>
        /// Data to be used to seed the MapAppUsers and ASPNetUsers tables
        /// </summary>
